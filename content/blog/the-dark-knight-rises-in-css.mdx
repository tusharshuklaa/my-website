...
<br />
<br />
Now that we know how to create a trapezoid, let's see how we can use this trick in our Batman face and start building the face of our Dark Knight.
...
*Creating a triangle* is very similar to creating a trapezoid. This can be achieved by setting the height __AND__ width of the element to 0 while retaining the trapezoid logic.
