...
export const metadata: Metadata = {
  ...
  keywords: ['about', 'frontend developer', 'React', 'TypeScript', 'web performance', 'CSS art'],
  openGraph: {
    type: 'website',
    title: 'About Me | Tushar Shukla',
    description:
  ...
  <div className="relative grid antialiased md:grid-flow-col md:grid-cols-[minmax(20vw,auto)_1fr_minmax(150px,auto)]">
    ...
    <SnapSection className="relative mx-auto mt-20 max-w-4xl px-4 md:mt-40 md:px-2">
      ...
      <JustText>
        ...
        <br />
        🦸🏻 <strong>Anime Enthusiast:</strong> When I&apos;m not coding, I&apos;m probably watching anime — One Piece
        and Naruto taught me more about perseverance than any self-help book.
        <br />🎨 <strong>CSS Art:</strong> I create CSS Art in my free time because who needs a drawing tablet when you
        have clip-path and box-shadow?
        <br />🔧 <strong>Tech &amp; Gadgets:</strong> I&apos;m always on the lookout for new tech and gadgets to geek
        out over because, let&apos;s be honest, who doesn&apos;t love a shiny new toy that makes life easier (or at
        least more fun)?
        <br />
        🏍️ <strong>Motorcycle Riding:</strong> There&apos;s nothing quite like the feeling of the open road, wind in your
        face, and the hum of an engine beneath you (dug dug dug dug dug....💨). It&apos;s my way of escaping the digital
        world and recharging my creative batteries — though I&apos;m pretty sure my helmet hair is a CSS challenge
        I&apos;ll never fully solve..
      </JustText>
