...
export const ContactSection: FC<UiComponent> = ({ className, ...props }) => {
  const contactSectionClasses = cn('max-w-sm md:max-w-7xl m-auto pt-16 md:pt-28 flex flex-col justify-center', className);
  ...
  return (
    <SnapSection data-testid={`cmp-contact-section`} className={contactSectionClasses} {...props}>
      ...
      <div className="grid grid-cols-2 gap-2 ms:gap-0 md:flex md:justify-between mt-20 md:mt-32">
        {
