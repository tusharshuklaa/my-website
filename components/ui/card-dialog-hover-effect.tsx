            ...
            <Dialog>
              ...
              <DialogContent className="max-w-sm sm:max-w-lg lg:max-w-2xl">
                <DialogHeader className="space-y-4">
                  ...
                  <DialogTitle className="text-2xl text-center">{item.title}</DialogTitle>
                </DialogHeader>
                <DialogDescription asChild>
                  <div className="max-h-[40vh] overflow-y-auto leading-6 prose dark:prose-dark tracking-wide">
