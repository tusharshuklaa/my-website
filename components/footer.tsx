...
export const Footer: FC = () => {
  ...
  return (
    <footer className="flex flex-col w-full pt-40 pb-8 bg-gradient-to-t from-60% from-sky-950/30 to-transparent to-100%">
      <div className="mb-14 flex justify-between w-full max-w-7xl m-auto">
        <div className="w-1/2">
          ...
          <p className="mt-4">Show some love to my <Link href=""><Underline>Github repository</Underline></Link> for this website</p>
          <p className="mt-4">
